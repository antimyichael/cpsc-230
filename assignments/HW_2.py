...
Print out the set.
'''
print('Please input 5 integer values.')
x1 = int(input()); x2 = int(input()); x3 = int(input()); x4 = int(input()); x5 = int(input())
set_vars = {x1, x2, x3, x4, x5}
print (set_vars)
...
print(str(mins_input//60) + " hours, " +  str(mins_input%60) + " minutes")