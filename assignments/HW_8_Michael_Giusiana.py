...
for i in range(len(coordinates)):
    print(" X: " + str(coordinates[i][0]) + ", Y: " + str(coordinates[i][1]))

### c)
print("The euclidean distance between " + str(coordinates[0]) + " and " + str(coordinates[1]) + " is " + str(((((coordinates[1][0]-coordinates[0][0])**2)+(((coordinates[0][1]-coordinates[1][1])**2)))**(1/2))))
