...
# write your code below
print("a) " + str(len(temperatures)))
print("b) " + str(max(temperatures)))
print("c) " + str(sum(temperatures)))
print("d) " + str((sum(temperatures))/len(temperatures)))
print("e) " + str(sorted(temperatures)))
print("f) " + str(sorted(temperatures, reverse=True)))
...
sumReviews = "%.2f" % (sum(reviews))
sumReviews = float(sumReviews)
print("1) " + str(sumReviews))
print("2)\nMin: " + str(min(reviews)) + "\nMax: " + str(max(reviews)))
print("3)", str("%.2f" % ((sumReviews)/len(reviews))))
print("4)\n" + str(sorted(reviews)) + "\n" + str(sorted(reviews, reverse=True)))
reviews.remove(min(reviews))
sumReviews = float("%.2f" % (sum(reviews)))
print("5)", str("%.2f" % ((sumReviews)/len(reviews))))
