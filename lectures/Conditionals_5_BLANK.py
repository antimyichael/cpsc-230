...
class_name = input("Which class are you here for?")
...
'''
# write your code below
x = int(input("Give me a number and I'll tell you if it's even or not"))
if x%2==0:
    print("It's even")
else:
    print("It's not even")
...
'''
# write your code below
player1_choice = input("Player 1, select your move")
player2_choice = input("Player 2, select your move")
