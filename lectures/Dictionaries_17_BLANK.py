...
inventory = {"apples": 30, "bananas": 45, "oranges": 20} # a)
print(inventory["bananas"]) # b)
inventory["bananas"]+=25; print(inventory["bananas"]) # c)
inventory["oranges"]-=5; print(inventory["oranges"]) # d)
inventory["pears"] = 10; print(inventory) # e)
del inventory["apples"]; print(inventory) # f)
...
# write your code below
inventory = {"apples": 30, "bananas": 45, "oranges": 20} # a)
print(inventory.get("bananas")) # b)
inventory["bananas"]+=25; print(inventory["bananas"]) # c)
inventory.update({"oranges": inventory["oranges"]-5}); print(inventory["oranges"]) # d)
inventory.update({"pears": 10}); print(inventory) # e)
inventory.pop("apples"); print(inventory) # f)
